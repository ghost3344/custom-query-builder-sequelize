...
var _actor_info = require("./actor_info");
var _address = require("./address");
var _category = require("./category");
var _city = require("./city");
var _country = require("./country");
var _customer = require("./customer");
var _customer_list = require("./customer_list");
var _film = require("./film");
var _film_actor = require("./film_actor");
var _film_category = require("./film_category");
var _film_list = require("./film_list");
var _film_text = require("./film_text");
var _inventory = require("./inventory");
var _language = require("./language");
var _nicer_but_slower_film_list = require("./nicer_but_slower_film_list");
var _payment = require("./payment");
var _rental = require("./rental");
var _sales_by_film_category = require("./sales_by_film_category");
var _sales_by_store = require("./sales_by_store");
var _staff = require("./staff");
var _staff_list = require("./staff_list");
var _store = require("./store");

function initModels(sequelize) {
  var actor = _actor(sequelize, DataTypes);
  var actor_info = _actor_info(sequelize, DataTypes);
  var address = _address(sequelize, DataTypes);
  var category = _category(sequelize, DataTypes);
  var city = _city(sequelize, DataTypes);
  var country = _country(sequelize, DataTypes);
  var customer = _customer(sequelize, DataTypes);
  var customer_list = _customer_list(sequelize, DataTypes);
  ...
  var film_list = _film_list(sequelize, DataTypes);
  ...
  var nicer_but_slower_film_list = _nicer_but_slower_film_list(
    sequelize,
    DataTypes
  );
  var payment = _payment(sequelize, DataTypes);
  var rental = _rental(sequelize, DataTypes);
  var sales_by_film_category = _sales_by_film_category(sequelize, DataTypes);
  var sales_by_store = _sales_by_store(sequelize, DataTypes);
  var staff = _staff(sequelize, DataTypes);
  var staff_list = _staff_list(sequelize, DataTypes);
